...
function login(username, password) {
    ...
    if (user) {
        ...
        // FIX: Save to BOTH sessionStorage AND localStorage
        sessionStorage.setItem('rentarium_session', JSON.stringify(session));
...
window.addEventListener('load', function() {
    ...
    // FIX: Don't auto-redirect from login page
