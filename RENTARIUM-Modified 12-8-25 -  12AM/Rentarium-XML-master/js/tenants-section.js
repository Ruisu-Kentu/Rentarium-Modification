/* tenants-section.js - Complete Fixed Version */
...
(function () {
      ...
      <tr>
        <td>
          <div class="tenant-info">
            <div class="tenant-avatar">${getInitials(t.name || t.username)}</div>
    ...
    refs.gridItems.innerHTML = list.map(t => `
      <div class="tenant-card">
        <div class="tenant-card-header">
          <div class="tenant-card-avatar">${getInitials(t.name || t.username)}</div>
      ...
      try {
        ...
        for (let i = 0; i < tenantNodes.length; i++) {
          ...
          const tenant = {
            ...
            password: 'changeme123', // default password for imported tenants
  ...
  function init() {
    ...
    console.log('Tenants Section initialized:', {
