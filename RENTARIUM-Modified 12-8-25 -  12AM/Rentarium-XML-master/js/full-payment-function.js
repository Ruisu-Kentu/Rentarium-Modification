...
const PaymentStorage = {
  ...
  createPayment(paymentData) {
    ...
    // FIXED: Determine payment type correctly
    let paymentType = 'Monthly Rent'; // Default
    
    // If paymentData has paymentType, use it
    if (paymentData.paymentType && paymentData.paymentType.trim() !== '') {
      paymentType = paymentData.paymentType;
    }
    // If billDetails exists, it's likely Utility Bills
    ...
    const payment = {
      ...
      paymentType: paymentType, // FIXED: Use determined payment type
